...
wlan_emu_sta_iphone_t::wlan_emu_sta_iphone_t(unsigned int dev_id, unsigned int test_id, wifi_vap_info_t *vap, sta_profile_t *profile)
{
    unsigned char val[8] = {0x0a, 0x00, 0x01, 0x04, 0x00, 0x00, 0x00, 0x00};
    m_model = sta_model_type_iphone;
    m_oui[0] = 0x00; m_oui[1] = 0x17; m_oui[2] = 0xf2;
...
wlan_emu_sta_pixel_t::wlan_emu_sta_pixel_t(unsigned int dev_id, unsigned int test_id, wifi_vap_info_t *vap, sta_profile_t *profile)
{
    m_model = sta_model_type_pixel;
    m_oui[0] = 0xc8; m_oui[1] = 0x2a; m_oui[2] = 0xdd;
    unsigned char val[8] = {0x0a, 0x00, 0x01, 0x04, 0x00, 0x00, 0x00, 0x00};
