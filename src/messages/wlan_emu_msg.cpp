...
void wlan_emu_msg_t::send_ctrl_msg(wlan_emu_test_coverage_t coverage, wlan_emu_test_type_t type, wlan_emu_emu80211_ctrl_type_t ctrl)
{
    int fd;
    ssize_t sz;
...
void wlan_emu_msg_t::send_ctrl_msg(unsigned char *buff, unsigned int buff_len, wlan_emu_emu80211_cmd_type_t ctrl)
{
    int fd;
    ssize_t sz;
...
static unsigned char radio_tap_header[] = {0x00, 0x00, 0x3c, 0x00, 0x2f, 0x40, 0x10, 0xa0, 0x20, 0x08, 0x00, 0xa0, 0x20, 0x08, 0x00, 0xa0, 0x20, 0x08, 0x00, 0xa0, 0x20, 0x08, 0x00, 0x00, 0x71, 0xa1, 0x64, 0x15, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0c, 0x3c, 0x14, 0x40, 0x01, 0xe4, 0x00, 0x00, 0x00, 0x00, 0x00, 0xc3, 0x00, 0xf6, 0x05, 0x0c, 0x00, 0x00, 0x00, 0xe1, 0x00, 0xdb, 0x01, 0xd9, 0x02, 0xe0, 0x03};
...
int wlan_emu_msg_t::dump(test_step_params_t *step)
{
    ...
    if (msg_type == wlan_emu_msg_type_frm80211) {
        ...
        //Filling Tail.
        memcpy(buff, f_data->u.cfg80211.u.start_ap.ap_params.beacon.tail, f_data->u.cfg80211.u.start_ap.ap_params.beacon.tail_len);
