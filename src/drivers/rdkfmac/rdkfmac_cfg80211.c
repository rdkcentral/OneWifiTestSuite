...
void *prep_cfg80211_spec(wlan_emu_msg_data_t *spec, wlan_emu_cfg80211_ops_type_t ops)
{
    wlan_emu_msg_cfg80211_t    *cfg80211;

    memset(spec, 0, sizeof(wlan_emu_msg_data_t));
    spec->type = wlan_emu_msg_type_cfg80211;
    cfg80211 = &spec->u.cfg80211;
    cfg80211->ops = ops;

    return (void *)(&cfg80211->ops + sizeof(wlan_emu_cfg80211_ops_type_t));
}
                        ...
                        struct vif_params *params)
{
    ...
    add_intf = (wlan_emu_cfg80211_add_intf_t *)prep_cfg80211_spec(&spec, wlan_emu_cfg80211_ops_type_add_intf);
...
static int ieee80211_del_iface(struct wiphy *wiphy, struct wireless_dev *wdev)
{
    ...
    del_intf = (wlan_emu_cfg80211_del_intf_t *)prep_cfg80211_spec(&spec, wlan_emu_cfg80211_ops_type_del_intf);
    push_to_char_device(&spec);
                  ...
                  struct vif_params *params)
{
    ...
    change_intf = (wlan_emu_cfg80211_change_intf_t *)prep_cfg80211_spec(&spec, wlan_emu_cfg80211_ops_type_change_intf);
    push_to_char_device(&spec);
                  ...
                  struct cfg80211_ap_settings *params)
{
    ...
    start_ap = (wlan_emu_cfg80211_start_ap_t *)prep_cfg80211_spec(&spec, wlan_emu_cfg80211_ops_type_start_ap);
    push_to_char_device(&spec);
                 ...
                 unsigned int link_id)
{
    ...
    stop_ap = (wlan_emu_cfg80211_stop_ap_t *)prep_cfg80211_spec(&spec, wlan_emu_cfg80211_ops_type_stop_ap);
    push_to_char_device(&spec);
...
const struct cfg80211_ops rdkfmac_config_ops = {
