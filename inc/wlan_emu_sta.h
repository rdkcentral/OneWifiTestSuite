...
public:
    ...
    inline void set_dev_id(unsigned int id) { m_dev = id; }
    inline void set_test_id(unsigned int id) { m_test = id; }
    inline void add_profile(sta_profile_t *profile) { memcpy(&m_profile, profile, sizeof(sta_profile_t)); }

    inline unsigned int get_dev_id() { return m_dev; }
    inline unsigned int get_test_id() { return m_test; }

    inline wifi_vap_info_t *get_sta() { return &m_sta; }
    inline void set_vap(wifi_vap_info_t *vap) { memcpy(&m_sta, vap, sizeof(wifi_vap_info_t)); }
...
public:
    ...
    wlan_emu_sta_iphone_t(unsigned int dev_id, unsigned int test_id, wifi_vap_info_t *vap, sta_profile_t *profile);
...
public:
    ...
    wlan_emu_sta_pixel_t(unsigned int dev_id, unsigned int test_id, wifi_vap_info_t *vap, sta_profile_t *profile);
